...
abstract class GitCommitCountValueSource : ValueSource<String, ValueSourceParameters.None> {
    ...
    override fun obtain(): String {
        ...
        // Official CI keeps origin/master available. Local clones and imported repositories may
        // not, so use the checked-out commit history rather than collapsing every build to 1.
        return count("refs/remotes/origin/master") ?: count("HEAD") ?: "1"
    }
}
